...
import { Sparkles, Lock, Mail, AlertCircle, Loader2, KeyRound, Smartphone, ShieldAlert } from 'lucide-react';
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#090c13' }}>
